...
export type OrbShape = 'default' | 'flower-of-life' | 'flower-of-life-complete' | 'star-of-david' | 'merkaba' | 'earth' | 'tree-of-life' | 'grid-of-life' | 'sri-yantra' | 'triquetra' | 'golden-rectangles' | 'double-helix-dna' | 'vortex-ring';
